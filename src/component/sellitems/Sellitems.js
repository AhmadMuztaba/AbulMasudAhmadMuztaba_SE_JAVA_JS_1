                    ...
                    <div className="itemsell__form">
                        <form className="itemsell__form--form" encType="multipart/form-data" onSubmit={(e) => {
                            ...
                            <div className="itemsell__form--form__itemname">
                                ...
                                <input className="itemsell__form--form__itemname--input" type="text"value={this.state.itemname} name="itemName" placeholder="" onChange={(e) => {
                            ...
                            <div className="itemsell__form--form__itemAuthor">
                                ...
                                <input className="itemsell__form--form__itemAuthor--input" type="text" name="itemBrand" value={this.state.itemBrand}placeholder="" onChange={(e) => {
                            ...
                            <div className="itemsell__form--form__price">
                                ...
                                <input className="itemsell__form--form__price--input" type="text" name="price" value={this.state.price} placeholder="" onChange={(e) => {
                                    this.setState({ price: e.target.value })
                                }} /><br />
                            </div>
                            <div className="itemsell__form--form__price">
                                <label className="itemsell__form--form__price--label" for="profitpercent"><b>Profit Percentage</b></label>
                                <input className="itemsell__form--form__price--input" type="text" name="profitpercent" value={this.state.profitpercent} placeholder="" onChange={(e) => {
